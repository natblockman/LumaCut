...
- นำเข้าวิดีโอหลายไฟล์พร้อมกันด้วยปุ่มหรือการลากแล้ววาง โดยระบบวางคลิปเรียงต่อกันใน Timeline อัตโนมัติ
...
- เพิ่มสติกเกอร์ OpenMoji ฟรี และ GIF Meme เคลื่อนไหว 8 แบบ พร้อมค้นหา กรองหมวด ปรับขนาด การหมุน ความทึบ และเวลาแสดงผล
...
- Windows: `LumaCut-Setup-1.19.0.exe`
- Linux: `LumaCut-1.19.0.AppImage`
...
1. ดาวน์โหลด `LumaCut-Setup-1.19.0.exe` จากหน้า Releases
...
1. ดาวน์โหลด `LumaCut-1.19.0.AppImage` จากหน้า Releases
2. เปิด Terminal ในโฟลเดอร์ที่เก็บไฟล์
3. เพิ่มสิทธิ์ให้ไฟล์สามารถทำงานได้:

```bash
chmod +x LumaCut-1.19.0.AppImage
```

4. เปิดโปรแกรม:

```bash
./LumaCut-1.19.0.AppImage
```

หาก AppImage เปิดไม่ได้เพราะระบบไม่มี FUSE สามารถทดลองรันแบบแตกไฟล์ชั่วคราว:

```bash
./LumaCut-1.19.0.AppImage --appimage-extract-and-run
```

## เริ่มตัดต่อครั้งแรก

1. กด **Import media / นำเข้าสื่อ** แล้วเลือกวิดีโอหนึ่งไฟล์หรือหลายไฟล์พร้อมกัน วิดีโอแต่ละไฟล์จะถูกเพิ่มเป็นคลิปและเรียงต่อกันใน Timeline
...
2. เลือกแท็บ **GIF memes / GIF มีม** เพื่อแสดงเฉพาะภาพเคลื่อนไหว หรือค้นหาจากชื่อและคำสำคัญ
3. คลิก GIF ที่ต้องการเพื่อเพิ่มลงในแทร็กสติกเกอร์ ณ ตำแหน่งหัวอ่าน
4. ลาก GIF บนหน้าพรีวิวเพื่อย้ายตำแหน่ง และใช้แผงด้านขวาเพื่อปรับขนาด การหมุน ความทึบ เวลาแสดงผล และ Animation
5. GIF จะเคลื่อนไหวทั้งในพรีวิวและวิดีโอที่ส่งออก
